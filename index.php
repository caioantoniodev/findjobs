...
<body>
    ...
    <div class="caption text-center">
        ...
        <a href="login.html"><button type="button" class="btn btn-outline-light btn-lg">Sign In</button></a>
        <a href="register.html"><button type="button" class="btn btn-light btn-lg">Register</button></a>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center text-center">
            ...
            <div class="col-12">
                <a href="projects.html"><button type="button" class="btn btn-outline-dark btn-lg">See Projects</button></a>
            </div>
    ...
    <div class="container padding" align="center">
        <div class="row text-center justify-content-center" style="width: 100%;">
            ...
            <div class="col-12">
                <a href="classes.html"><button type="button" class="btn btn-outline-dark btn-lg">Access All Content</button></a>
            </div>
        </div>
        <hr>
    </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content col-12">
                        ...
                        <div class="modal-body">
                            ...
                            <a class="link" href="contact.html">Did you have any problem?</a>
                        </div>				  
                    </div>
                </div>
            </div>
